...
Altay is still in a very early phase of development, and could always use
a bit of help. Here are a couple of things you could do to help out:

File Bug Reports
----------------

As with most open source projects, Altay does not have a dedicated team
...
Altay is written completely in Python, and uses only cross-platform
...
making quality releases. No experiences with Altay on Mac so far, but I'd
